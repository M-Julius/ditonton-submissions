...
class TvSeriesRepositoryImpl implements TvSeriesRepository {
  ...
  Future<Either<Failure, List<TvSeries>>> getNowPlayingTvSeries() async {
    try {
      ...
      return const Left(SSLFailure('Certificate ssl not valid'));
    } catch (e) {
  ...
  Future<Either<Failure, String>> saveTvSeriesWatchlist(
    ...
    try {
      final result = await localDataSource
          .insertTvSeriesWatchlist(TvSeriesTable.fromEntity(tv));
      return Right(result);
  ...
  Future<Either<Failure, String>> removeTvSeriesWatchlist(
    ...
    try {
      final result = await localDataSource
          .removeTvSeriesWatchlist(TvSeriesTable.fromEntity(tv));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    }
